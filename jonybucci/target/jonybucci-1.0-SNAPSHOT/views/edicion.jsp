...
<%
    if (!(boolean)session.getAttribute("isLogin")){
        response.sendRedirect("/jonybucci/");
    }
...
<main class="container d-flex justify-content-center align-items-center">
                ...
                <h3 class="text-success"> Bienvenido <%= name %> <%= last_name %></h3>

    <form method="POST" action="/jonybucci/usuario/updateUser" class="w-50 px-5 py-4 rounded" >
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/jonybucci/usuario/deleteUser" class="btn btn-danger">Eliminar</a>
            </div>
            <div class="col-auto">
                <a href="/jonybucci/" class="btn btn-sm btn-dark ">Volver al INICIO</a>
            </div>
        </div>
    </form>
